...
//   let header = table.insertRow();
//   header.innerHTML =
//     "<th>Sản phẩm</th><th>Giá</th><th>Số lượng</th><th>Tổng</th><th>Hành động</th>";
...
// function removeFromCart(productName) {
//   let product = cart.find((item) => item.product_name === productName);
//   if (product) {
//     product.quantity -= 1;
...
//   alert(
//     `Cảm ơn bạn, ${name}! Đơn hàng của bạn đã được đặt. Chúng tôi sẽ giao hàng tới ${address}.`
//   );
...
// // Example product data (you would replace this with your actual product data)
...
linkBrand.classList.add("navbar-brand");
linkBrand.setAttribute("href", "http://127.0.0.1:5500/Home/Home.html");
linkBrand.style.color = "white";
linkBrand.innerText = "UEFA.com";
